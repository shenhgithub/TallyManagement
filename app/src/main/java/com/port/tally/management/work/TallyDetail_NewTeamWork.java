...
import com.port.tally.management.data.TallyDetail_NewTeamData;
 ...
 */
public class TallyDetail_NewTeamWork extends DefaultWorkModel<String,List<Map<String, Object>>, TallyDetail_NewTeamData> {
    ...
    protected String onTaskUri() {
        return StaticValue.HTTP_GET_NewTeam_URL;
    }
     ...
     */
    @Override
    protected List<Map<String, Object>> onRequestSuccessSetResult(TallyDetail_NewTeamData data) {
        return data.getAll();
    }
     ...
     */
    @Override
    protected List<Map<String, Object>> onRequestFailedSetResult(TallyDetail_NewTeamData data) {
        return null;
    }
    ...
    protected TallyDetail_NewTeamData onCreateDataModel(String... parameters) {
        TallyDetail_NewTeamData tallyDetail_TeamData = new TallyDetail_NewTeamData();
