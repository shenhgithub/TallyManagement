 ...
 */
public class GetCornerPileDataAdapter extends BaseAdapter implements Filterable {
    private ArrayFilter mFilter;
    private List<Map<String, Object>> mList;
    private Context context;
    private ArrayList<Map<String, Object>> mUnfilteredData;

    public GetCornerPileDataAdapter(List<Map<String, Object>> mList, Context context) {
        this.mList = mList;
