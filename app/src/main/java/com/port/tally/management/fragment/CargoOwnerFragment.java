...
public class CargoOwnerFragment extends BaseCodeListFragment<CargoOwner, String> {
    ...
    @Override
    protected void onFillDataList(@Nullable List<CargoOwner> dataList, List<Map<String, String>>
            mapList) {
    ...
    protected String onActionTag() {
        return StaticValue.CodeListTag.CARGO_OWNER_LIST;
    }

    @Override
    protected EditText onFilterEditText(View rootView) {
        return (EditText) getActivity().findViewById(R.id.cargo_owner_edit_editText);
    }
