 ...
 */
public class GetFlagAutoDataAdapter extends BaseAdapter implements Filterable {
    private ArrayFilter mFilter;
    private List<Map<String, Object>> mList;
    private Context context;
    private ArrayList<Map<String, Object>> mUnfilteredData;

    public GetFlagAutoDataAdapter(List<Map<String, Object>> mList, Context context) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            view = View.inflate(context, R.layout.flagauto_item, null);
        ...
        if(!item.get("tv1").equals("")){
            holder.tv_2.setText((CharSequence)item.get("tv1"));}
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (pc != null) {
                        if(pc.get("tv3")!=null && ((CharSequence)pc.get("tv3")).toString().toLowerCase().startsWith(prefixString)){
                            ...
                            newValues.add(pc);
                        }else if(pc.get("tv1")!=null && ((CharSequence)pc.get("tv1")).toString().toLowerCase().startsWith(prefixString)){
                            newValues.add(pc);
                        }
                    }
                }
