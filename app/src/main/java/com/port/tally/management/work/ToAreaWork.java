 ...
 */
public class ToAreaWork extends DefaultWorkModel<String, List<Map<String, Object>>,ToAreaData> {
     ...
     */
    @Override
    protected List<Map<String, Object>> onRequestSuccessSetResult(ToAreaData data) {
        return data.getAll();
    }
     ...
     */
    @Override
    protected List<Map<String, Object>> onRequestFailedSetResult( ToAreaData data) {
        return null;
    }
     ...
     */
    @Override
    protected  ToAreaData onCreateDataModel(String... parameters) {
        ToAreaData toAreaData = new ToAreaData();
