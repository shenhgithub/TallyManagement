 ...
 */
public class GetAllocationDataAdapter extends BaseAdapter {
    ...
    public GetAllocationDataAdapter(List<Map<String, Object>> data, Context context) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            view = View.inflate(context, R.layout.getallocation_item, null);
