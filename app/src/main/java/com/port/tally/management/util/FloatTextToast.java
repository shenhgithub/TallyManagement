...
public class FloatTextToast {
     ...
     */
    public static FloatTextToast makeText(Context context, View targetView, String text, int
            duration) {
    ...
    public static Dialog makeText(OnClickListener onClickListener, ImageView myImageView, String
            text, int lengthLong) {
