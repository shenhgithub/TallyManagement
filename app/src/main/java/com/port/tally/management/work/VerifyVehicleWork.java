 ...
 */
public class VerifyVehicleWork extends DefaultWorkModel<String, StartWorkBean, VerifyVehicleData> {
    ...
    protected String onTaskUri() {
        return StaticValue.HTTP_GET_VERIFYVEHICLE_URL;
    }
     ...
     */
    @Override
    protected StartWorkBean onRequestSuccessSetResult(VerifyVehicleData data) {
     ...
     */
    @Override
    protected StartWorkBean onRequestFailedSetResult(VerifyVehicleData data) {
        return data.getStartWorkBean();
    }
     ...
     */
    @Override
    protected VerifyVehicleData onCreateDataModel(String... parameters) {
        VerifyVehicleData verifyVehicleData = new VerifyVehicleData();

        verifyVehicleData.setSearchContent(parameters[0]);
        verifyVehicleData.setCompany(parameters[1]);
        verifyVehicleData.setType(parameters[2]);
        return verifyVehicleData;
    }
