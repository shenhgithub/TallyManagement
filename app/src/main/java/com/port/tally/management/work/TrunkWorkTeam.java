...
import com.port.tally.management.data.TrunkWorkTeamData;
 ...
 */
public class TrunkWorkTeam extends DefaultWorkModel<String, List<TrunkWorkTeamBean>, TrunkWorkTeamData> {
     ...
     */
    @Override
    protected List<TrunkWorkTeamBean> onRequestSuccessSetResult(TrunkWorkTeamData trunkWorkTeamData) {
        return null;
    }
    /**
     * 服务返回数据解析成功后，
     ...
     */
    @Override
    protected List<TrunkWorkTeamBean> onRequestFailedSetResult(TrunkWorkTeamData trunkWorkTeamData) {
        return trunkWorkTeamData.getTrunkWorkTeamBeanList();
    }
    /**
     * 创建数据模型对象并填充参数，
     ...
     */
    @Override
    protected TrunkWorkTeamData onCreateDataModel(String... parameters) {
        TrunkWorkTeamData trunkWorkTeamData = new TrunkWorkTeamData();

        trunkWorkTeamData.setSearchContent(parameters[0]);

        return trunkWorkTeamData;
    }
}
