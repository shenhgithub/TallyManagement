 ...
 */
public class TrunkQueryWork extends DefaultWorkModel<String, TrunkQueryBean, TrunkQueryData> {
     ...
     */
    @Override
    protected TrunkQueryBean onRequestSuccessSetResult(TrunkQueryData data) {
        return data.getTrunkQueryBean();
    }
     ...
     */
    @Override
    protected TrunkQueryBean onRequestFailedSetResult(TrunkQueryData data) {
        return null;
    }
    ...
    protected TrunkQueryData onCreateDataModel(String... parameters) {
        TrunkQueryData trunkQueryData = new TrunkQueryData();

        trunkQueryData.setSearchContent(parameters[0]);

        return trunkQueryData;
    }
}
